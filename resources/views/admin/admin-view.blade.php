                            ...
                            @if ($appointment->id == request()->id)
                                <form class="cta-form" method="POST" action="{{ route('admin.return-requestform', ['id' => $appointment->id]) }}">
                                    ...
                                    <div class="form-floating mb-3 mt-3">
                                        ...
                                        <textarea class="form-control"  id="admin_comment" name="admin_comment" style="height: 150px"></textarea>
                                         </div>

                                    <div class="mb-2 pt-2 text-right">
                                        <a class="btn btn-lg btn--cta text-white text-decoration-none mx-3" href="{{ route('admin-form', ['id' => $appointment->id]) }}" role="button">Set Appointment</a>
                                        <button type="submit" name="action" value="return" class="btn btn-lg btn--cta text-white text-decoration-none">Submit</button>
                                    </div>
